  ...
  _handlePanResponderEnd: function(e: Object, gestureState: Object) {
    ...
    if (this.state.swiping) {
      if (openRight && contentPos < 0 && posX < 0) {
        // open swipeout right
        if(this.props.onOpenedRight){
          this.props.onOpenedRight(this.props.sectionID, this.props.rowID);
        }
        ...
        // open swipeout left
        if(this.props.onOpenedLeft){
          this.props.onOpenedLeft(this.props.sectionID, this.props.rowID);
        }
